import type { Organization, Department, Team, Group, PaginatedResult, PaginationParams } from "@sohaara/types";
import type { OrganizationProvider } from '../providers/organization-provider.interface';
export declare class LocalOrganizationProvider implements OrganizationProvider {
    readonly name = "local";
